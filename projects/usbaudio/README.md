...
## 接進相簿之前要先解決的：PLL3Q 撞車

USB 全速要 **PLL3Q = 48.000MHz**，而相簿的 PLL3 已經三個人在搶
（board-notes 23.1）：PLL3R 給 LTDC 的像素時脈、**PLL3Q 給 I2S 的
49.1521MHz**。一顆 PLL 的 Q 輸出只有一個值。

這是整合的第一道題，而且**不能用「重設 PLL3」解決** —— 23.1 記過，
動一顆正在被使用的 PLL 兩種死法都試過了。
