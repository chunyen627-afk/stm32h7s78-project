...
"$IDE" --launcher.suppressErrors -nosplash -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data "$WSPATH" -import "$IMPORT" -build 'Video_Appli/Debug' 2>&1 |
