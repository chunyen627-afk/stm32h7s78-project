...
- **顯示方向**可選直立 / 橫向 / 自動 —— 橫式照片切到橫向可以從 480x320
  放大到 720x480，面積 2.25 倍
...
所以「自動」（依每張照片的長寬比決定）適合**拿在手上翻看**，可以跟著轉手；
**立在桌上播放**建議固定直立或橫向，否則相框不會自己轉，會有一半照片躺著。
